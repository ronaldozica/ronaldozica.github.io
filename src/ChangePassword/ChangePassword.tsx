...
const LoginForm = () => {
	...
	return (
		<Form.Root onSubmit={onSubmit} className="FormRoot">
			...
			<Form.Field className="FormField" name="old-password">
				<div
					style={{
						display: "flex",
						alignItems: "baseline",
				...
				>
					<Form.Label className="FormLabel">Senha antiga</Form.Label>
					<Form.Message className="FormMessage" match="valueMissing">
						Por favor, preencha sua senha antiga
					</Form.Message>
				</div>
				<Form.Control asChild>
					<input
				...
				<div
					...
					onClick={() => setOldHidePassword((prev) => !prev)}
				>
					{hideOldPassword ? (
						<svg
			...
			<Form.Field className="FormField Pass-teste" name="password">
				<div
					style={{
						display: "flex",
						alignItems: "baseline",
