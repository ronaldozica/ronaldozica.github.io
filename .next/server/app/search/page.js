...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 5073))
...
__webpack_require__.d(__webpack_exports__, {
  SearchProducts: () => (/* binding */ SearchProducts)
});
...
// EXTERNAL MODULE: ./components/product.tsx + 2 modules
var components_product = __webpack_require__(8680);
...
const alertVariants = (0,index_cjs/* cva */.j)("relative w-full rounded-lg border p-4 [&:has(svg)]:pl-11 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground", {
    variants: {
        variant: {
...
/* __next_internal_client_entry_do_not_use__ SearchProducts auto */ 
...
function SearchProducts() {
    ...
    const [products, setProducts] = (0,react_.useState)(null);
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx(jsx_runtime_.Fragment, {
        children: products && products.length > 0 ? products.map((product)=>/*#__PURE__*/ jsx_runtime_.jsx("div", {
                children: /*#__PURE__*/ jsx_runtime_.jsx(components_product["default"], {
                    id: product.id,
                    caption: product.caption,
                    media_url: product.media_url,
                    permalink: product.permalink
                })
            }, product.id)) : isLoading ? /*#__PURE__*/ jsx_runtime_.jsx(jsx_runtime_.Fragment, {}) : /*#__PURE__*/ (0,jsx_runtime_.jsxs)(Alert, {
            variant: "destructive",
            children: [
                /*#__PURE__*/ jsx_runtime_.jsx(lucide_react/* AlertCircle */.bG7, {
                    className: "h-4 w-4"
                }),
                /*#__PURE__*/ jsx_runtime_.jsx(AlertTitle, {
                    children: "Erro"
                }),
                /*#__PURE__*/ jsx_runtime_.jsx(AlertDescription, {
                    children: "N\xe3o foi poss\xedvel carregar produtos com a sua pesquisa"
                })
            ]
        })
    });
